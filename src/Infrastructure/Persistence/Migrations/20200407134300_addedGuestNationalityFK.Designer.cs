...
namespace SkipperAgency.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20200407134300_addedGuestNationalityFK")]
    partial class AddedGuestNationalityFk
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkipperBooking.DAL.Entities.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SkipperBooking.DAL.Entities.AppUser", b =>
                {
                    b.HasOne("SkipperBooking.DAL.Entities.Country", "Country")
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("SkipperBooking.DAL.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("SkipperBooking.DAL.Entities.Country", "GuestNationality")
                        .WithMany()
