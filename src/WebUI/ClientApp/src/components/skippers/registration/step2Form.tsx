...
export const SkipperRegistrationFormStep2: React.FC<IProps> = (
  props: IProps
) => {
  function SelectField(FieldProps: any) {
    return (
      <Select
        ...
        value={FieldProps.country ? FieldProps.country.label : ""}
        id="country"
        placeholder="Country"
    ...
    <div>
      ...
      <Formik
        ...
        validationSchema={Yup.object().shape({
          ...
          photoURL: Yup.string().required("Molimo odaberite sliku"),
        })}
      >
        {(formikProps: any) => {
          const {
            ...
            <Form onSubmit={handleSubmit}>
              <Grid container direction="row" spacing={6}>
                <Grid item xs={12} sm={4}>
                  <span className={styles.pitchLine} style={{ marginLeft: 15 }}>
                    Profile picture
                  </span>
                  <Grid container spacing={4}>
                    <Grid item xs={12} container justify="center">
                      ...
                      />
                      {props.photoURL === "" ? (
                        <div className={styles.noPhotoHolder}>
                          <span>
                            Browse photos from your computer in .jpg, .jpeg. and
                            .png format.
                          </span>
                        </div>
                      ) : (
                    ...
                    <Grid item xs={12} sm={6} className={styles.spacing}>
                      <div id="dateOfBirth">
                        {/* <DatePicker
                          ...
                          format={"dd.MM.yyyy."}
                          onChange={(value: any) =>
                            setFieldValue("dateOfBirth", value.toDateString())
                          }
                          locale="hr-HR"
                          name="Date of birth"
                        /> */}
                  ...
                  <Grid container item xs={12} justify="center">
                    ...
                    <Grid item xs={12} sm={6} className={styles.spacing}>
                      <TextInput
                        ...
                        errors={errors}
                        touched={touched}
                        value={props.values && props.values.zipCode}
                  ...
                  <Grid container item xs={12} justify="center">
                    <Grid item xs={12} sm={6} className={styles.spacing}>
                      <TextInput
                        ...
                        errors={errors}
                        touched={touched}
                        value={props.values && props.values.city}
                        placeholder="City"
                      />
                    </Grid>
                    <Grid item xs={12} sm={6} className={styles.spacing}>
                      <FormControl
                        className={styles.formSelect + " " + styles.margin}
                      >
                        <Field
                          name="country"
                          options={props.countries}
                  ...
                  <Grid container item xs={12} justify="flex-start">
                    <Grid item xs={12} sm={6} className={styles.spacing}>
                      <TextInput
                        ...
                        errors={errors}
                        touched={touched}
                        value={props.values && props.values.phoneNumber}
